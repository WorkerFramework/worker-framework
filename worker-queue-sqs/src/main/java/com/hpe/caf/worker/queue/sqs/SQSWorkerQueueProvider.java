...
public class SQSWorkerQueueProvider implements WorkerQueueProvider
{
    @Override
    ...
    {
        try {
            // DDD ignoring max tasks as SQS has hard max of 10.
            return new SQSWorkerQueue(configurationSource.getConfiguration(SQSWorkerQueueConfiguration.class));
