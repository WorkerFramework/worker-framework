...
class WorkerTaskImpl implements WorkerTask
{
    ...
    private final boolean sendNewFormat;
            ...
            final boolean sendNewFormat)
    {
        ...
        this.sendNewFormat = sendNewFormat;
    ...
    public void sendMessage(final TaskMessage tm)
    {
        ...
        workerCallback.send(taskInformation, tm, sendNewFormat);
    }
    ...
    private void publishSubtask(final TaskMessage responseMessage)
    {
        ...
        // Publish this message
        workerCallback.send(taskInformation, responseMessage, sendNewFormat);
    ...
    private void completeResponse(final TaskMessage responseMessage)
    {
        ...
        // Complete the task
        workerCallback.complete(taskInformation, responseMessage.getTo(), responseMessage, sendNewFormat);
    }
    ...
    private void publishReportUpdates(final List<TaskMessage> reportUpdates)
    {
        ...
        workerCallback.reportUpdate(taskInformation, reportUpdateMessage, sendNewFormat);
    }
