...
import com.hpe.caf.worker.queue.rabbit.RabbitWorkerQueueProvider;
import com.hpe.caf.worker.queue.sqs.SQSWorkerQueueProvider;
import jakarta.validation.constraints.NotNull;
import jakarta.validation.constraints.Size;

@Configuration
public class WorkerQueueProviderFactoryImpl implements WorkerQueueProviderFactory
{
    public WorkerQueueProviderFactoryImpl()
    {
    }
    ...
    {
        return ("SQS".equalsIgnoreCase(queueImplementation)) ? new SQSWorkerQueueProvider() : new RabbitWorkerQueueProvider();
    }
}
