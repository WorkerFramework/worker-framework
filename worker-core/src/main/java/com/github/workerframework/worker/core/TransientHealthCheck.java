...
public class TransientHealthCheck implements HealthReporter
{
     ...
     * are found within the range the health check returns Healthy.
     *
    ...
    /**
     * This method adds the supplied exceptionMsg text as a key to a Map and adds the time now as the corresponding value. This Map
     * represents the Transient Exception Registry, which is use to store Transient Exceptions.
     *
