...
import com.opentext.caf.api.worker.ManagedWorkerQueue;
import com.opentext.caf.api.worker.QueueException;
import com.opentext.caf.api.worker.TaskCallback;
import com.opentext.caf.api.worker.TaskInformation;
import com.opentext.caf.api.worker.WorkerQueueMetricsReporter;
import com.opentext.caf.util.rabbitmq.ConsumerAckEvent;
import com.opentext.caf.util.rabbitmq.ConsumerDropEvent;
import com.opentext.caf.util.rabbitmq.ConsumerRejectEvent;
import com.opentext.caf.util.rabbitmq.DefaultRabbitConsumer;
import com.opentext.caf.util.rabbitmq.Event;
import com.opentext.caf.util.rabbitmq.EventPoller;
import com.opentext.caf.util.rabbitmq.QueueConsumer;
import com.opentext.caf.util.rabbitmq.RabbitUtil;
