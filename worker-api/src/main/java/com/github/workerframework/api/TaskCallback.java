...
public interface TaskCallback
{
     ...
     * @param taskMessage the task data that is specific to the workers hosted
     ...
     */
    void registerNewTask(TaskInformation taskInformation, TaskMessage taskMessage, Map<String, Object> headers)
