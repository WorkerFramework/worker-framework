...
public class TestConfiguration<TWorkerTask, TWorkerResult, TInput, TExpectation> {
    ...
    public TestConfiguration(String testDataFolder, String testDocumentsFolder, boolean useDataStore, String dataStoreContainerId, Class<TWorkerTask> workerTaskClass, Class<TWorkerResult> workerResultClass, Class<TInput> inputClass, Class<TExpectation> expectationClass) {
