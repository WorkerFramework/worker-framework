 ...
 */
public class ExampleTestControllerProvider extends AbstractTestControllerProvider<ExampleWorkerConfiguration, ExampleWorkerTask, ExampleWorkerResult, ExampleTestInput, ExampleTestExpectation>
{
     ...
     */
    @Override
    protected WorkerTaskFactory<ExampleWorkerTask, ExampleTestInput, ExampleTestExpectation> getTaskFactory(TestConfiguration<ExampleWorkerTask, ExampleWorkerResult, ExampleTestInput, ExampleTestExpectation> configuration)
        throws Exception
    {
