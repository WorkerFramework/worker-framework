...
public class ExampleResultPreparationProvider extends PreparationItemProvider<ExampleWorkerTask, ExampleWorkerResult, ExampleTestInput, ExampleTestExpectation>
{
    ...
    /**
     * Method for generating test items from the yaml testcases. Creates ExampleTestInput and ExampleTestExpectation objects (which
     * contain ExampleWorkerTask and ExampleWorkerResult). The ExampleWorkerTask found in ExampleTestInput is fed into the worker for the
     * integration test, and the result is compared with the ExampleWorkerResult found in the ExampleTestExpectation.
     *
     * @param inputFile
     * @param expectedFile
     * @return TestItem
