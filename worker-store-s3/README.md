# Worker Store S3 [![Build Status](http://cafbuilder.hpswlabs.hp.com:8080/buildStatus/icon?job=worker-store-s3)](http://cafbuilder.hpswlabs.hp.com:8080/job/worker-store-s3)
